...
files=list.files(path = "/Users/michael/Documents/pic-sure-metadata-curation/numom2b/inputs/", pattern = "*.xlsx")

raw_master_df <- read_xlsx(paste0("/Users/michael/Documents/pic-sure-metadata-curation/numom2b/inputs/",files[1]), col_names = FALSE)

for (df_file in files) {
  tmp_df <- read_xlsx(paste0("/Users/michael/Documents/pic-sure-metadata-curation/numom2b/inputs/",df_file),col_names = FALSE)
